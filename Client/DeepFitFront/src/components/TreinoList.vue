            ...
            v-for="(exercicio, index) in exercicios" :key="index" @click="openDialog(exercicio)">
                ...
                <v-list-item-content>
                    ...
                    <v-list-item-subtitle class="d-flex">
                        <span class="ml-2 mr-auto my-1 font-italic">{{ 'Séries/Reps: ' + exercicio.series + '/' +
                            exercicio.reps }}</span>
        ...
        <v-dialog v-model="dialog" max-width="300">
            <v-card>
                ...
                <v-card-text>
                    <v-form>
                        <div class="d-flex">
                            <v-text-field v-model="selectedExercise.series" label="Séries" class="mr-4"></v-text-field>
                        ...
                        <v-card-actions class="d-flex justify-center">
                            ...
                            <v-btn rounded="xl" variant="tonal" color="grey darken-2" @click="closeDialog">Cancelar</v-btn>
                        </v-card-actions>
                    </v-form>
                </v-card-text>
            </v-card>
